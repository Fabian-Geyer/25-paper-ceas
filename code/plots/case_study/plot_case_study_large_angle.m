...
%% 15 degree pitch
experimentName = 'case_study_large_angle';
[thisFolder, ~] = fileparts(mfilename("fullpath"));
% experiment_folder = "SoarStabilityAnalysis-27-Dec-2024-16-51-59"; old
experiment_folder = "SoarStabilityAnalysis-07-Jan-2025-19-16-21";
...
cleanfigure;
matlab2tikz('../../../paper/Figures/case_study_large_angle.tikz', 'width','15cm','height','7cm') % for large angle figure